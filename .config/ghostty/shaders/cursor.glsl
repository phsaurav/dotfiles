...
const vec4 TRAIL_COLOR = vec4(0.902, 0.765, 0.518, 0.025);
const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0.627, 0.4, 0.01);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if (isFarEnough && isOnSeparateLine) {
        ...
        newColor = mix(fragColor, TRAIL_COLOR, step(sdfTrail, 0.0));
